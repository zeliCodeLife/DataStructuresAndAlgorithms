 ...
 * 2) 单向链表不能自我删除，需要靠辅助节点 ，而双向链表，则可以自我删除，所以前面我们单链表删除节点时，
 *    总是找到 temp,temp 是待删除节点的前一个节点(认真体会).
 */
...
class DoubleLinkedList{
    ...
    public void update(HeroNode2 newHeroNode) {
        ...
        //2.定位heroNode的位置,找到需要修改的节点, 根据 no 编号,定义一个辅助变量
        HeroNode2 tmp = head.next;
